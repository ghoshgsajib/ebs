...
public class DepositeDetails  extends JFrame implements ActionListener {
    ...
    DepositeDetails(){
        ...
        JLabel Iblmeternumber = new JLabel("Search By Meter Number");
        Iblmeternumber.setBounds(20,20,150,20);
        add(Iblmeternumber);
        ...
        JLabel Iblmonth = new JLabel("Search By Month");
          Iblmonth.setBounds(400,20,100,20);
        add(Iblmonth);
